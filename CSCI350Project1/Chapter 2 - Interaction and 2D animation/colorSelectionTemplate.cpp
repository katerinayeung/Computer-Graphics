...
void mouseClick(int button, int state, int x, int y)
{
	char red[] = "RED";
	char green[] = "GREEN";
	//TODO: declare the other two strings, one for green and one for yellow. 
	...
	if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN)
	{
		...
		//TODO: do similar things for the other two color regions
	}
...
void main()
{
	...
	glutCreateWindow("Color selection");
	init();
